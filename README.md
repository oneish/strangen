...
```bash
cmake --build bake --target demo && ./bake/demo
```
...
```bash
cmake --build bake --target baggage_example && ./bake/baggage_example
```
...
```bash
cmake --build bake --target currants_example && ./bake/currants_example
```
