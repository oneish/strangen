...
int main()
{
    ...
    {
        std::cout << "implementation_template" << std::endl;
        auto w1 = example::widget::_make<implementation_template<int>>();
        w1.inc();
        auto w2 = ++w1;
        w1.display();
        w2.display();
        ...
        auto b1 = example::button::_make<implementation_template<int>>()--;
        if (b1._something())
        {
            std::cout << "yes" << b1._error() << std::endl;
        }
        ...
        auto n1 = example::number::_make<implementation_template<int>>();
        n1.inc();
        n1.dec();

        auto wn1 = example::widget_number::_make<implementation_template<int>>();
        wn1.inc();
        wn1.display();
        ...
        auto ni1 = example::numeric<int>::_make<implementation_template<int>>();
        ni1.inc();
        auto ni2 = ni1;
        ni2.x() = 2;
        std::cout << ni1.get() << ni1.x() << ni2.x() << std::endl;
