...
template<>
struct reflection<toast::widget>
{
...
struct reflection<toast::widget_<_Thing, _Copy>>
{
    static inline auto name() -> std::string
    {
        return "toast::widget_<" + reflection<_Thing>::name() + ", " + (_Copy ? "true" : "false") + ">";
    }
};

template<>
struct reflection<toast::button>
{
    static inline auto name() -> std::string
    {
        return "toast::button";
...
template<typename _Thing, bool _Copy>
struct reflection<toast::button_<_Thing, _Copy>>
{
    static inline auto name() -> std::string
    {
        return "toast::button_<" + reflection<_Thing>::name() + ", " + (_Copy ? "true" : "false") + ">";
    }
};

template<>
struct reflection<toast::number>
{
    static inline auto name() -> std::string
    {
        return "toast::number";
...
template<typename _Thing, bool _Copy>
struct reflection<toast::number_<_Thing, _Copy>>
{
    static inline auto name() -> std::string
    {
        return "toast::number_<" + reflection<_Thing>::name() + ", " + (_Copy ? "true" : "false") + ">";
    }
};

template<>
struct reflection<toast::widget_number>
{
    static inline auto name() -> std::string
    {
        return "toast::widget_number";
    }
};

template<typename _Thing, bool _Copy>
struct reflection<toast::widget_number_<_Thing, _Copy>>
{
    static inline auto name() -> std::string
    {
        return "toast::widget_number_<" + reflection<_Thing>::name() + ", " + (_Copy ? "true" : "false") + ">";
    }
};

template<typename Data>
struct reflection<toast::numeric<Data>>
{
    static inline auto name() -> std::string
    {
        return "toast::numeric<" + reflection<Data>::name() + ">";
    }
};

template<typename Data, typename _Thing, bool _Copy>
struct reflection<toast::numeric_<Data, _Thing, _Copy>>
{
    static inline auto name() -> std::string
    {
        return "toast::numeric_<" + reflection<Data>::name() + ", " + reflection<_Thing>::name() + ", " + (_Copy ? "true" : "false") + ">";
    }
};
...
public:
    ...
    static inline std::string const _cat_ = strange::reflection<_Kind_>::name();
...
public:
    ...
    static inline std::string const _name_ = strange::reflection<_Abstraction_>::name();
};
