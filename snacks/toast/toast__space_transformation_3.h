...
struct reflection<toast::numeric<Data>>
{
    static inline auto name() -> std::string
    {
        return "toast::numeric<" + concatename<false, Data>() + ">";
    }
};

template<typename _Thing, bool _Copy, typename Data>
struct reflection<toast::numeric_<_Thing, _Copy, Data>>
{
    static inline auto name() -> std::string
    {
        return "toast::numeric_<" + reflection<_Thing>::name() + ", " + (_Copy ? "true" : "false") + concatename<true, Data>() + ">";
    }
};
...
public:
    ...
    static inline auto _manufacture_(std::string const & name) -> widget_number_
    {
        ...
        return widget_number_{it->second()};
    }
